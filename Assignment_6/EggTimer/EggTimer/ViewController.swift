...
//  EggTimer
//
//  Created by Елшан Арсен on 23.10.2024.
//
...
class ViewController: UIViewController {
    ...
    func playAlarmSound() {
        if let soundURL = URL(string: "/Users/elsanarsen/Desktop/Swift/Basic_Swift/Assignment_6/EggTimer/EggTimer/Assets.xcassets/A.wav") {
